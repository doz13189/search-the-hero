	...
	heroes: [
		...
		},
		{
			...
			"autoSkill1": {
				...
				"tags": ["resilience", "powerUpSingle", "lastStand"]
		...
		},
		{
			...
			"autoSkill2": {
				...
				"tags": ["skillImpactUpSingle", "lastStand"]
			},
		},
		{
			"id": "1101010",
			...
			"plusUltra": {
				...
				"tags": ["lastStand", "cooldownTimeReductionSingle", "skillImpactUpSingle"]
			...
			"actionSkill2": {
				...
				"coolDown": "Cool Down 5 Turns",
				"tags": ["powerUpSingle", "skillImpactUpSingle", "lastStand"]
		...
		},
		{
			...
			"plusUltra": {
				...
				"tags": ["boundSingle", "bindHitRateUp", "bullseye"]
			},
			"actionSkill1": {
				"name": "セントルイススマッシュ",
			...
			"autoSkill1": {
				...
				"tags": ["resilience", "defenseUpSingle"]
			},
			"autoSkill2": {
				"name": "Auto Skill Lv.3",
		...
		},
		{
			...
			"plusUltra": {
				...
				"tags": ["resilience", "boundSingle", "cooldownTimeReductionSingle", "removeStatusChangesSingle"]
			...
			"actionSkill1": {
				...
				"tags": ["maxHpUpSingle", "skillImpactUpSingle", "plusUltraGaugeUpSingle", "lastStand"]
			...
			"autoSkill1": {
				...
				"tags": ["defenseUpSingle", "bleedingSingle", "lastStand"]
			},
			"autoSkill2": {
				"name": "Auto Skill Lv.3",
				...
				"tags": ["resilience", "powerUpSingle", "cooldownTimeReductionSingle", "defenseDownSingle"]
			},
		},
		{
			"id": "1101014",
			...
			"actionSkill1": {
				...
				"coolDown": "Cool Down 5 Turns",
				"tags": ["lastStand", "criticalHitRateUpSingle"]
			},
			"actionSkill2": {
				"name": "デラウェアスマッシュ",
		...
		},
		{
			...
			"plusUltra": {
				...
				"tags": ["powerUpAll", "statusAilmentNullAll", "lastStand"]
		...
		},
		{
			...
			"autoSkill1": {
				...
				"tags": ["cooldownTimeReductionSingle", "plusUltraGaugeUpSingle", "lastStand"]
			},
			"autoSkill2": {
				"name": "Auto Skill Lv.3",
		...
		},
		{
			...
			"actionSkill1": {
				...
				"coolDown": "Cool Down 4 Turns",
				"tags": ["cancelStatusAilmentsSingle", "piercingShot", "skillImpactUpSingle"]
			...
			"actionSkill2": {
				...
				"coolDown": "Cool Down 4 Turns",
				"tags": ["cancelStatusAilmentsSingle", "boundSingle", "defenseDownSingle", "skillImpactUpSingle"]
		...
		},
		{
			...
			"actionSkill2": {
				...
				"coolDown": "Cool Down 4 Turns",
				"tags": ["skillImpactDownSingle", "lastStand"]
			},
			"autoSkill1": {
				"name": "Auto Skill Lv.3",
		...
		},
		{
			...
			"plusUltra": {
				"name": "Plus Ultra Move Lv.3",
				"description": "ハウザーインパクト 敵単体に700%ダメージ/敵が燃焼状態だったらスキル威力が50%アップ",
		...
		},
		{
			...
			"tags": ["barrier", "cooldownTimeReductionSingle", "counter", "provocation", "damageReductionSingle", "stunSingle", "skillImpactUpSingle", "skillImpactUpAll"]
		},
		{
			"id": "1244001",
			"epithet": "米国最強",
