	...
	heroes: [
		...
		},
		{
			...
			"actionSkill1": {
				...
				"coolDown": "Cool Down 5 Turns",
				"tags": ["lastStandSingle", "criticalHitRateUpSingle", "criticalHitImpactUpSingle"]
			},
			"actionSkill2": {
				"name": "デラウェアスマッシュ",
		...
		},
		{
			...
			"plusUltra": {
				...
				"tags": ["removeBuffsSingle", "skillImpactUpAll", "piercingShot"]
		...
		},
		{
			...
			"autoSkill2": {
				...
				"tags": ["composureSingle", "speedUpSingle"]
		...
		},
		{
			...
			"plusUltra": {
				...
				"tags": ["barrierSingle", "recoverySingle"]
		...
		},
		{
			...
			"autoSkill2": {
				...
				"tags": ["skillImpactDownAll", "cooldownTimeDownAll", "cooldownTimeUpAll", "plusUltraGaugeUpAll"]
		...
		},
		{
			...
			"autoSkill1": {
				...
				"tags": ["cancelStatusAilmentsSingle", "criticalHitRateUpAll"]
		...
		},
		{
			...
			"plusUltra": {
				...
				"tags": ["boundSingle", "recoveryBlockSingle", "actionSkillImpactDownAll"]
			...
			"actionSkill2": {
				...
				"coolDown": "Cool Down 4 Turns",
				"tags": ["powerDownAll", "speedDownAll", "plusUltraGaugeUpSingle", "plusUltraGaugeDownAll"]
		...
		},
		{
			...
			"plusUltra": {
				...
				"tags": ["stunSingle", "criticalHitImpactUpAll", "plusUltraGaugeUpAll"]
			...
			"actionSkill2": {
				...
				"coolDown": "Cool Down 5 Turns",
				"tags": ["criticalHitRateUpAll", "criticalHitImpactUpAll", "maxHpUpAll", "barrierAll"]
		...
		},
		{
			...
			"actionSkill1": {
				...
				"coolDown": "Cool Down 4 Turns",
				"tags": ["speedUpAll", "ecstaticSingle"]
			},
			"actionSkill2": {
				"name": "ターボチャージャー",
		...
		},
		{
			...
			"autoSkill2": {
				...
				"tags": ["skillImpactUpSingle", "speedUpSingle"]
			},
		},
		{
			"id": "1104010",
			...
			"actionSkill1": {
				...
				"coolDown": "Cool Down 6 Turns",
				"tags": ["speedUpSingle", "doubleAttackSingle", "criticalHitRateUpAll", "criticalHitImpactUpAll"]
			},
			"actionSkill2": {
				"name": "レシプロバースト",
		...
		},
		{
			...
			"autoSkill2": {
				...
				"tags": ["powerUpSingle", "frozenSingle", "statusAilmentCounter"]
			},
		},
		{
			"id": "1105004",
		...
		},
		{
			...
			"actionSkill1": {
				...
				"coolDown": "Cool Down 5 Turns",
				"tags": ["powerUpSingle", "burnResistUpAll", "freezeResistUpAll"]
			},
			"actionSkill2": {
				"name": "氷塊",
		...
		},
		{
			...
			"plusUltra": {
				...
				"tags": ["criticalHitImpactUpSingle", "burningSingle"]
			},
			"actionSkill1": {
				"name": "氷塊",
			...
			"actionSkill2": {
				...
				"coolDown": "Cool Down 6 Turns",
				"tags": ["criticalHitRateUpSingle", "plusUltraGaugeUpSingle", "criticalHitImpactUpSingle"]
			},
			"autoSkill1": {
				"name": "Auto Skill Lv.3",
			...
			"autoSkill2": {
				...
				"tags": ["plusUltraGaugeUpSingle", "criticalHitImpactUpSingle"]
			},
		},
		{
			"id": "1105008",
			...
			"autoSkill1": {
				...
				"tags": ["ecstaticSingle", "powerUpSingle", "burnResistUpAll"]
			},
			"autoSkill2": {
				"name": "Auto Skill Lv.3",
		...
		},
		{
			...
			"plusUltra": {
				...
				"tags": ["frozenSingle", "defenseDownSingle", "skillImpactUpSingle"]
			},
			"actionSkill1": {
				"name": "氷塊",
		...
		},
		{
			...
			"actionSkill1": {
				...
				"coolDown": "Cool Down 5 Turns",
				"tags": ["frozenAll", "burningAll", "burnResistUpAll"]
			},
			"actionSkill2": {
				"name": "炎舞",
			...
			"autoSkill1": {
				...
				"tags": ["speedUpSingle", "burnHitRateUpSingle", "freezeHitRateUpSingle"]
			},
			"autoSkill2": {
				"name": "Auto Skill Lv.3",
		...
		},
		{
			...
			"actionSkill2": {
				...
				"coolDown": "Cool Down 5 Turns",
				"tags": ["frozenAll", "maxHpUpAll", "burnImmunityAll"]
			},
			"autoSkill1": {
				"name": "Auto Skill Lv.3",
				...
				"tags": ["actionSkillImpactUpAll", "speedUpAll", "defenseUpAll"]
			},
			"autoSkill2": {
				"name": "Auto Skill Lv.3",
		...
		},
		{
			...
			"actionSkill1": {
				...
				"coolDown": "Cool Down 6 Turns",
				"tags": ["camouflage", "criticalHitRateUpSingle"]
			},
			"actionSkill2": {
				"name": "フロッピキック",
		...
		},
		{
			...
			"actionSkill2": {
				...
				"coolDown": "Cool Down 5 Turns",
				"tags": ["camouflage", "criticalHitRateUpAll"]
			},
			"autoSkill1": {
				"name": "Auto Skill Lv.3",
		...
		},
		{
			...
			"plusUltra": {
				...
				"tags": ["cooldownTimeReductionSingle", "skillImpactUpSingle", "criticalHitRateUpSingle"]
			},
			"actionSkill1": {
				"name": "フロッピスイング",
				"description": "敵全体に300%ダメージ、パワーを30%ダウン(3ターン)/自分が隠れるの時、スキル威力を30%アップ",
				"coolDown": "Cool Down 4 Turns",
				"tags": ["powerDownAll", "skillImpactUpSingle"]
			},
			"actionSkill2": {
				"name": "フロッピスピア",
				"description": "敵単体に400%ダメージ/自分のプルスウルトラゲージを30%アップ/自分が隠れるの時、スキル威力を30%アップ",
				"coolDown": "Cool Down 4 Turns",
				"tags": ["plusUltraGaugeUpSingle", "skillImpactUpSingle"]
			},
			"autoSkill1": {
				"name": "Auto Skill Lv.3",
		...
		},
		{
			...
			"actionSkill2": {
				...
				"coolDown": "Cool Down 3 Turns",
				"tags": ["speedDownAll", "actionSkillImpactDownAll"]
			},
			"autoSkill1": {
				"name": "Auto Skill Lv.3",
		...
		},
		{
			...
			"actionSkill2": {
				...
				"coolDown": "Cool Down 4 Turns",
				"tags": ["cover", "hpRegenerationSingle", "powerUpSingle"]
			},
			"autoSkill1": {
				"name": "Auto Skill Lv.3",
		...
		},
		{
			...
			"actionSkill1": {
				...
				"coolDown": "Cool Down 3 Turns",
				"tags": ["criticalHitRateDownSingle", "skillImpactUpSingle"]
			},
			"actionSkill2": {
				"name": "俺が守る！",
				"description": "自分にかばう(2ターン)を付与/このスキルでCHAIN成功時、自分が受けるダメージを35%カット(2ターン)/自分以外の味方全体のパワーを10%アップ",
				"coolDown": "Cool Down 5 Turns",
				"tags": ["cover", "damageDownSingle", "powerUpAll"]
			},
			"autoSkill1": {
				"name": "Auto Skill Lv.3",
		...
		},
		{
			...
			"actionSkill2": {
				...
				"coolDown": "Cool Down 5 Turns",
				"tags": ["counter", "barrierSingle", "skillImpactUpSingle"]
			},
			"autoSkill1": {
				"name": "Auto Skill Lv.3",
		...
		},
		{
			...
			"autoSkill2": {
				...
				"tags": ["skillImpactUpSingle", "defenseUpSingle", "stunImmunity", "fearImmunity"]
			},
		},
		{
			"id": "1108011",
			...
			"actionSkill1": {
				...
				"coolDown": "Cool Down 4 Turns",
				"tags": ["skillImpactUpSingle", "defenseUpSingle"]
			},
			"actionSkill2": {
				"name": "烈怒交吽咤",
		...
		},
		{
			...
			"actionSkill1": {
				...
				"coolDown": "Cool Down 5 Turns",
				"tags": ["powerDownSingle", "speedDownSingle", "cover", "barrierSingle"]
			},
			"actionSkill2": {
				"name": "烈怒大車輪",
			...
			"autoSkill1": {
				...
				"tags": ["damageDownSingle", "criticalHitRateUpSingle", "barrierSingle", "statusAilmentNullSingle"]
			},
			"autoSkill2": {
				"name": "Auto Skill Lv.3",
		...
		},
		{
			...
			"actionSkill2": {
				...
				"coolDown": "Cool Down 6 Turns",
				"tags": ["hpRegenerationAll", "defenseUpSingle"]
			},
			"autoSkill1": {
				"name": "Auto Skill Lv.3",
		...
		},
		{
			...
			"actionSkill1": {
				...
				"coolDown": "Cool Down 6 Turns",
				"tags": ["cancelStatusAilmentsAll", "recoveryAll", "plusUltraMoveImpactUpAll"]
			},
			"actionSkill2": {
				"name": "マトリョーシカ",
		...
		},
		{
			...
			"actionSkill1": {
				...
				"coolDown": "Cool Down 6 Turns",
				"tags": ["recoveryAll", "plusUltraGaugeUpAll"]
			...
			"actionSkill2": {
				...
				"coolDown": "Cool Down 4 Turns",
				"tags": ["barrierAll", "powerUpSingle", "criticalHitRateUpSingle"]

			},
			"autoSkill1": {
				"name": "Auto Skill Lv.3",
				"description": "セレブリティ WAVE開始後、自分に余裕(3ターン)を付与、敵単体のスピードを20%ダウン(3ターン)",
				"tags": ["composureSingle", "speedDownSingle"]
			},
			"autoSkill2": {
				"name": "Auto Skill Lv.3",
		...
		},
		{
			...
			"actionSkill1": {
				...
				"coolDown": "Cool Down 5 Turns",
				"tags": ["boundSingle", "speedDownSingle", "plusUltraGaugeUpSingle"]
		...
		},
		{
			...
			"actionSkill1": {
				...
				"coolDown": "Cool Down 5 Turns",
				"tags": ["plusUltraGaugeUpSingle", "skillImpactUpAll"]
			},
			"actionSkill2": {
				"name": "ファーストエイド",
				"description": "味方全体のHPを30%回復/味方全体が受けるダメージを30%カット(2ターン)/自分のプルスウルトラゲージを20%アップ",
				"coolDown": "Cool Down 6 Turns",
				"tags": ["recoveryAll", "damageDownAll", "plusUltraGaugeUpSingle"]
			},
			"autoSkill1": {
				"name": "Auto Skill Lv.3",
		...
		},
		{
			...
			"actionSkill1": {
				...
				"coolDown": "Cool Down 5 Turns",
				"tags": ["skillImpactUpSingle", "defenseDownAll"]
			},
			"actionSkill2": {
				"name": "防御壁展開",
		...
		},
		{
			...
			"actionSkill2": {
				...
				"coolDown": "Cool Down 5 Turns",
				"tags": ["skillImpactUpSingle", "statusAilmentNullSingle"]
			},
			"autoSkill1": {
				"name": "Auto Skill Lv.3",
			...
			"autoSkill2": {
				...
				"tags": ["skillImpactUpSingle", "paralysisSingle", "statusAilmentCounter"]
			},
		},
		{
			"id": "1111004",
		...
		},
		{
			...
			"autoSkill1": {
				...
				"tags": ["plusUltraMoveImpactUpSingle", "defenseDownSingle"]
			},
			"autoSkill2": {
				"name": "Auto Skill Lv.3",
				"description": "余剰電力 HPが30％未満の時、自分が攻撃を受けると敵に麻痺(1ターン)を付与する/5ターン目から、1度だけ自分のプルスウルトラゲージを60%アップ",
				"tags": ["statusAilmentCounter", "paralysisSingle", "plusUltraGaugeUpSingle"]
			},
		},
		{
			"id": "1111007",
			...
			"autoSkill1": {
				...
				"tags": ["paralysisHitRateUpSingle", "criticalHitImpactUpSingle"]
			},
			"autoSkill2": {
				"name": "Auto Skill Lv.3",
				"description": "シビれる男 自分のクリティカル威力を30%アップ/自分のHPが50%未満の時、自分のクリティカル率を20%アップ",
				"tags": ["criticalHitImpactUpSingle", "criticalHitRateUpSingle"]
			},
		},
		{
			"id": "1111008",
			...
			"plusUltra": {
				...
				"tags": ["piercingShot", "bullseye", "confusionSingle"]
			},
			"actionSkill1": {
				"name": "人間スタンガン",
			...
			"actionSkill2": {
				...
				"coolDown": "Cool Down 3 Turns",
				"tags": ["plusUltraGaugeUpSingle", "statusAilmentCounter", "paralysisSingle", "dealtDamageRestoreSingle"]
			},
			"autoSkill1": {
				"name": "Auto Skill Lv.3",
		...
		},
		{
			...
			"autoSkill1": {
				...
				"tags": ["actionSkillImpactDownSingle"]
			},
			"autoSkill2": {
				"name": "Auto Skill Lv.3",
		...
		},
		{
			...
			"actionSkill2": {
				...
				"coolDown": "Cool Down 4 Turns",
				"tags": ["recoverySingle", "criticalHitRateUpSingle"]
			},
			"autoSkill1": {
				"name": "Auto Skill Lv.3",
		...
		},
		{
			...
			"actionSkill2": {
				...
				"coolDown": "Cool Down 5 Turns",
				"tags": ["recoverySingle", "plusUltraGaugeUpSingle", "skillImpactUpSingle"]
			},
			"autoSkill1": {
				"name": "Auto Skill Lv.3",
		...
		},
		{
			...
			"actionSkill1": {
				...
				"coolDown": "Cool Down 7 Turns",
				"tags": ["skillImpactDownAll", "plusUltraGaugeUpAll"]
			},
			"actionSkill2": {
				"name": "立体音響",
		...
		},
		{
			...
			"plusUltra": {
				...
				"tags": ["confusionSingle", "skillImpactUpSingle", "confusionHitRateUpSingle"]
			},
			"actionSkill1": {
				"name": "イヤホンジャック",
		...
		},
		{
			...
			"plusUltra": {
				...
				"tags": ["confusionSingle", "defenseDownSingle"]
			},
			"actionSkill1": {
				"name": "ハートビートファズ",
			...
			"actionSkill2": {
				...
				"coolDown": "Cool Down 5 Turns",
				"tags": ["confusionAll", "skillImpactUpSingle"]
			},
			"autoSkill1": {
				"name": "Auto Skill Lv.3",
		...
		},
		{
			...
			"autoSkill1": {
				...
				"tags": ["skillImpactDownAll", "confusionHitRateUpSingle"]
			},
			"autoSkill2": {
				"name": "Auto Skill Lv.3",
		...
		},
		{
			...
			"actionSkill1": {
				...
				"coolDown": "Cool Down 4 Turns",
				"tags": ["confusionSingle", "skillImpactUpAll", "hideAll", "hpRegenerationAll"]
			},
			"actionSkill2": {
				"name": "ステレオスピーカー",
			...
			"autoSkill1": {
				...
				"tags": ["statusAilmentNullAll", "plusUltraGaugeUpAll"]
			},
			"autoSkill2": {
				"name": "Auto Skill Lv.3",
				"description": "微音キャッチ 自分が攻撃を3回受けきった後に、味方全体の状態異常を1つ回復/自分が隠れる状態でない時、自分のディフェンスを50%アップ",
				"tags": ["cancelStatusAilmentsAll", "defenseUpSingle"]
			},
		},
		{
			"id": "1113010",
			...
			"plusUltra": {
				...
				"tags": ["recoveryAll", "powerUpSingle", "cooldownTimeReductionSingle"]
			},
			"actionSkill1": {
				"name": "癒やしの旋律",
				"description": "味方全体のHP25%回復、状態異常2個回復、スキル威力35%アップ(3ターン)",
				"coolDown": "Cool Down 5 Turns",
				"tags": ["recoveryAll", "cancelStatusAilmentsAll", "skillImpactUpAll"]
			},
			"actionSkill2": {
				"name": "ステレオスピーカー",
				"description": "敵全体に300%ダメージ/味方全体のHP20%回復、パワー20%アップ(3ターン)、被ダメージ20%回復(3ターン)を付与",
				"coolDown": "Cool Down 5 Turns",
				"tags": ["recoveryAll", "powerUpSingle", "damageTakenRestoreAll"]

			},
			"autoSkill1": {
				"name": "Auto Skill Lv.3",
				"description": "ハスキーセクシーボイス 味方全体の\"雄英高校生徒\"の最大HP40%アップ/自分が攻撃を3回受けた時、味方全体の状態異常1個回復",
				"tags": ["maxHpUpAll", "cancelStatusAilmentsAll"]
			},
			"autoSkill2": {
				"name": "Auto Skill Lv.3",
		...
		},
		{
			...
			"plusUltra": {
				...
				"tags": ["defenseDownSingle", "removeBuffsSingle"]
			},
			"actionSkill1": {
				"name": "アシッドブレイク",
				"description": "敵単体に300%ダメージ/敵単体のパワーを30%ダウン(3ターン)/敵単体の一時的な強化を高 確率 (65%)で1つ解除する",
				"coolDown": "Cool Down 4 Turns",
				"tags": ["powerDownSingle", "removeBuffsSingle"]
			},
			"actionSkill2": {
				"name": "滑走準備",
		...
		},
		{
			...
			"plusUltra": {
				...
				"tags": ["cooldownTimeReductionSingle", "ecstaticSingle"]
			},
			"actionSkill1": {
				"name": "アシッドギフト",
				"description": "味方全体のスキル威力を25%アップ(3ターン)/味方全体のプルスウルトラゲージを30%アップ/自分がダメージカット状態の時、味方全体のアクションスキルのクールタイムを1短縮する",
				"coolDown": "Cool Down 6 Turns",
				"tags": ["skillImpactUpAll", "plusUltraGaugeUpAll", "cooldownTimeReductionSingle"]
			},
			"actionSkill2": {
				"name": "アシッドショット",
		...
		},
		{
			...
			"actionSkill2": {
				...
				"coolDown": "Cool Down 4 Turns",
				"tags": ["criticalHitRateUpSingle", "skillImpactUpAll", "recoveryAll", "lastStandAll"]
			},
			"autoSkill1": {
				"name": "Auto Skill Lv.3",
				...
				"tags": ["actionSkillDamageDownSingle", "hpRegenerationAll", "lastStandAll"]
			},
			"autoSkill2": {
				"name": "Auto Skill Lv.3",
				"description": "中距離支援 自分のHPが50%以上の時、味方全体のスピード30%アップ/自分がくいしばりのまま、2回ターンをまたいだ時、味方全体のクリティカル率30%アップ(2ターン)、HP15%回復(最大5回)",
				"tags": ["speedUpAll", "criticalHitRateUpAll", "recoverySingle"]
		...
		},
		{
			...
			"autoSkill1": {
				...
				"tags": ["stunResistUpAll", "bindResistUpAll", "confusionResistUpAll", "criticalHitRateUpSingle", "maxHpUpSingle"]
			},
			"autoSkill2": {
				"name": "Auto Skill Lv.3",
				"description": "包容力 1ターン毎に、味方全体のクリティカル率5%アップ(最大6回)/味方全体の\"雄英高校1年A組\"の最大HP20%アップ",
				"tags": ["criticalHitRateUpAll", "maxHpUpAll"]
			},
		},
		{
			"id": "1116001",
		...
		},
		{
			...
			"autoSkill2": {
				...
				"tags": ["speedUpSingle", "defenseUpSingle", "bindHitRateDownAll"]
			},
		},
		{
			"id": "1121001",
			...
			"plusUltra": {
				...
				"tags": ["skillImpactDownSingle", "defenseDownSingle"]
			},
			"actionSkill1": {
				"name": "ビッグポルターガイスト",
		...
		},
		{
			...
			"plusUltra": {
				...
				"tags": ["confusionSingle", "powerDownSingle", "aggro", "cooldownTimeReductionAll", "bullseye"]
			},
			"actionSkill1": {
				"name": "クレバーな思考",
				"description": "敵全体の一時的な強化2個解除、強化阻害(1ターン)を付与、スキル威力30%ダウン(3ターン)、スピード20%ダウン(3ターン)",
				"coolDown": "Cool Down 5 Turns",
				"tags": ["removeBuffsAll", "buffBlockAll", "skillImpactDownAll", "speedDownAll"]
			},
			"actionSkill2": {
				"name": "コピーツインインパクト",
			...
			"autoSkill2": {
				...
				"tags": ["evasionSingle", "statusAilmentNullSingle", "powerDownAll"]
		...
		},
		{
			...
			"plusUltra": {
				...
				"tags": ["skillImpactUpSingle", "powerDownSingle"]
			},
			"actionSkill1": {
				"name": "圧砕拳",
		...
		},
		{
			...
			"autoSkill2": {
				...
				"tags": ["burnResistUpSingle", "freezeResistUpSingle", "powerUpSingle"]
			},
		},
		{
			"id": "1136002",
			...
			"actionSkill2": {
				...
				"coolDown": "Cool Down 4 Turns",
				"tags": ["blindAll", "recoveryBlockAll", "actionSkillImpactDownAll"]
			},
			"autoSkill1": {
				"name": "Auto Skill Lv.3",
				"description": "キノコのエキスパート 3ターン毎に、敵全体のアクションスキル威力20%ダウン(2ターン)、クリティカル率20%ダウン(2ターン)/自分のHPが50%未満の時、自分のクールタイム2短縮(最大1回)",
				"tags": ["actionSkillImpactDownAll", "criticalHitRateDownAll", "cooldownTimeReductionSingle"]
			},
			"autoSkill2": {
				"name": "Auto Skill Lv.3",
				...
				"tags": ["statusAilmentCounter", "blindSingle", "criticalHitRateDownAll", "criticalResistanceDownAll"]
			},
		},
		{
			"id": "1141001",
		...
		},
		{
			...
			"actionSkill1": {
				...
				"coolDown": "Cool Down 5 Turns",
				"tags": ["criticalHitImpactUpSingle", "powerDownSingle"]
			},
			"actionSkill2": {
				"name": "経験則",
		...
		},
		{
			...
			"actionSkill2": {
				...
				"tags": ["counter", "criticalHitRateUpSingle", "skillImpactUpSingle"],
				"coolDown": "Cool Down 6 Turns"
			...
			"autoSkill1": {
				...
				"tags": ["evasionSingle", "plusUltraGaugeUpSingle"],
		...
		},
		{
			...
			"plusUltra": {
				...
				"tags": ["defenseDownSingle", "confusionSingle"],
			...
			"actionSkill2": {
				...
				"tags": ["speedDownSingle", "confusionSingle", "evasionSingle"],
				"coolDown": "Cool Down 4 Turns"
			...
			"autoSkill2": {
				...
				"tags": ["lastStandSingle", "persistence", "cover","bullseye", "defenseUpSingle"],
		...
		},
		{
			...
			"actionSkill2": {
				...
				"tags": ["criticalHitRateUpSingle", "skillImpactUpSingle"],
				"coolDown": "Cool Down 4 Turns"
		...
		},
		{
			...
			"actionSkill1": {
				...
				"tags": ["boundSingle", "powerUpSingle"],
				"coolDown": "Cool Down 5 Turns"
		...
		},
		{
			...
			"actionSkill1": {
				...
				"tags": ["speedDownSingle", "cover", "defenseUpSingle"],
				"coolDown": "Cool Down 4 Turns"
			...
			"actionSkill2": {
				...
				"tags": ["boundSingle", "defenseDownSingle"],
				"coolDown": "Cool Down 4 Turns"
		...
		},
		{
			...
			"actionSkill2": {
				...
				"tags": ["recoveryAll", "plusUltraGaugeUpSingle", "powerUpSingle"],
				"coolDown": "Cool Down 6 Turns"
		...
		},
		{
			...
			"plusUltra": {
				...
				"tags": ["plusUltraGaugeUpAll", "hpRegenerationAll"],

			},
			"actionSkill1": {
				"name": "幻想的な空の舞い",
				"description": "味方単体のHPを25%回復/味方単体のパワーを40%アップ(3ターン)/味方単体の状態異常を1つ回復/味方全体のHPを25%回復",
				"tags": ["recoverySingle", "powerUpSingle", "cancelStatusAilmentsSingle", "recoveryAll"],
				"coolDown": "Cool Down 6 Turns"
			...
			"actionSkill2": {
				...
				"tags": ["powerDownAll", "plusUltraGaugeUpAll"],
				"coolDown": "Cool Down 4 Turns"
		...
		},
		{
			...
			"autoSkill1": {
				...
				"tags": ["statusAilmentNullAll", "skillImpactUpSingle", "speedUpSingle"],

			},
			"autoSkill2": {
				"name": "Auto Skill Lv.3",
				"description": "ミスコングランプリ 3ターン毎に、自分に状態異常無効(2回)を付与/自分がHP回復を1回受けきった時、味方全体のディフェンス20%アップ(2ターン)、状態異常1個回復",
				"tags": ["statusAilmentNullSingle", "defenseUpAll", "cancelStatusAilmentsSingle"],
			},
		},
		{
			"id": "1145001",
		...
		},
		{
			...
			"actionSkill2": {
				...
				"tags": ["removeBuffsSingle", "defenseDownSingle", "speedDownSingle"],
				"coolDown": "Cool Down 4 Turns"
			...
			"autoSkill1": {
				...
				"tags": ["resilienceSingle", "plusUltraGaugeUpSingle"],

			},
			"autoSkill2": {
				"name": "Auto Skill Lv.3",
				"description": "凄いなぁヒーロー科 WAVE開始後、自分に高揚(3ターン)を付与、敵単体のクリティカル率を30%ダウン(3ターン)",
				"tags": ["ecstaticSingle", "criticalHitRateDownSingle"],
		...
		},
		{
			...
			"actionSkill2": {
				...
				"tags": ["confusionSingle", "defenseDownSingle", "criticalHitRateDownSingle"],
				"coolDown": "Cool Down 4 Turns"
		...
		},
		{
			...
			"autoSkill1": {
				...
				"tags": ["skillImpactUpSingle", "powerDownSingle", "speedDownSingle"],
			},
			"autoSkill2": {
				"name": "Auto Skill Lv.3",
		...
		},
		{
			...
			"plusUltra": {
				...
				"tags": ["skillImpactUpSingle", "actionSkillImpactDownAll"],
			},
			"actionSkill1": {
				"name": "TEXAS SMASH",
			...
			"autoSkill1": {
				...
				"tags": ["composureSingle", "plusUltraGaugeUpSingle"],
			},
			"autoSkill2": {
				"name": "Auto Skill Lv.3",
		...
		},
		{
			...
			"autoSkill1": {
				...
				"tags": ["criticalHitImpactUpSingle", "composureSingle"],
			},
			"autoSkill2": {
				"name": "Auto Skill Lv.3",
				"description": "ナチュラルボーンヒーロー 自分のHPが50%未満の時、自分のパワーを10%アップ、自分のスキル威力を20%アップ、自分のクリティカル率を10%アップ",
				"tags": ["powerUpSingle", "skillImpactUpSingle", "criticalHitRateUpSingle"],
			},
		},
		{
			"id": "1146005",
			...
			"plusUltra": {
				...
				"tags": ["powerUpSingle", "cooldownTimeReductionAll"],
			},
			"actionSkill1": {
				"name": "MICHIGAN SMASH",
		...
		},
		{
			...
			"actionSkill2": {
				...
				"tags": ["criticalHitRateUpSingle", "criticalHitImpactUpSingle"],
				"coolDown": "Cool Down 5 Turns"
			},
			"autoSkill1": {
				"name": "Auto Skill Lv.3",
		...
		},
		{
			...
			"actionSkill2": {
				...
				"coolDown": "Cool Down 5 Turns",
				"tags": ["lastStandSingle", "cooldownTimeReductionSingle", "plusUltraGaugeUpSingle"],
			...
			"autoSkill1": {
				...
				"tags": ["bleedingDamageDownSingle", "speedUpSingle", "powerDownSingle", "defenseDownSingle", "powerUpSingle", "damageTakenRestoreSingle", "defenseUpSingle"],
		...
		},
		{
			...
			"plusUltra": {
				...
				"tags": ["symbol", "skillImpactUpSingle"],

			},
			"actionSkill1": {
				"name": "MICHIGAN SMASH",
				"description": "敵単体に400%ダメージ、パワー35%ダウン(3ターン)/自分にかばう(2ターン)を付与",
				"tags": ["powerDownSingle", "cover"],
				"coolDown": "Cool Down 3 Turns"
			...
			"actionSkill2": {
				...
				"tags": ["cancelStatusAilmentsAll", "powerUpSingle", "plusUltraGaugeUpSingle", "symbol"],
				"coolDown": "Cool Down 4 Turns"
			...
			"autoSkill1": {
				...
				"tags": ["tranquility", "symbol", "maxHpUpSingle", "defenseUpSingle"],
			},
			"autoSkill2": {
				"name": "Auto Skill Lv.3",
				...
				"tags": ["cover", "defenseUpAll", "powerDownSingle", "damageTakenRestoreSingle", "symbol"],
			},
		},
		{
			"id": "1147001",
		...
		},
		{
			...
			"actionSkill1": {
				...
				"tags": ["removeBuffsSingle", "speedDownSingle", "criticalHitRateDownSingle"],
				"coolDown": "Cool Down 3 Turns"
		...
		},
		{
			...
			"plusUltra": {
				...
				"tags": ["removeBuffsSingle", "skillImpactUpSingle"],
			},
			"actionSkill1": {
				"name": "捕縛布",
			...
			"actionSkill2": {
				...
				"tags": ["removeBuffsSingle", "speedDownSingle", "skillImpactDownSingle"],
				"coolDown": "Cool Down 4 Turns"
			},
			"autoSkill1": {
				"name": "Auto Skill Lv.3",
			...
			"autoSkill2": {
				...
				"tags": ["criticalHitRateUpSingle", "criticalHitRateUpAll"],
			},
		},
		{
			"id": "1147004",
			...
			"plusUltra": {
				...
				"tags": ["boundSingle", "bindHitRateUpSingle"],
			},
			"actionSkill1": {
				"name": "捕縛強襲",
				"description": "敵単体に300%ダメージ/敵単体の一時的な強化を1つ解除する/敵単体のスキル威力を30%ダウン(3ターン)",
				"tags": ["removeBuffsSingle", "skillImpactDownSingle"],
				"coolDown": "Cool Down 5 Turns"
			},
			"actionSkill2": {
				"name": "合理的手段",
				"description": "味方単体の状態異常を1つ回復/味方単体の状態異常を防ぐ(1回)/味方単体のスキル威力を20%アップ(3ターン)/このスキルでCHAIN成功時、味方単体のプルスウルトラゲージを35%アップ",
				"tags": ["cancelStatusAilmentsSingle", "statusAilmentNullSingle", "skillImpactUpSingle", "plusUltraGaugeUpSingle"],
				"coolDown": "Cool Down 5 Turns"
			},
			"autoSkill1": {
				"name": "Auto Skill Lv.3",
		...
		},
		{
			...
			"plusUltra": {
				...
				"tags": ["removeBuffsSingle", "boundSingle", "evasionSingle"],
			},
			"actionSkill1": {
				"name": "抹消鉄拳",
			...
			"actionSkill2": {
				...
				"tags": ["removeBuffsAll", "defenseDownSingle", "skillImpactDownSingle"],
				"coolDown": "Cool Down 4 Turns"
			},
			"autoSkill1": {
				"name": "Auto Skill Lv.3",
			...
			"autoSkill2": {
				...
				"tags": ["removeBuffsAll", "criticalHitRateUpSingle", "bindHitRateUpSingle", "speedDownAll"],
			},
		},
		{
			"id": "1148001",
		...
		},
		{
			...
			"plusUltra": {
				...
				"tags": ["bullseye", "cooldownTimeReductionSingle"],

			},
			"actionSkill1": {
				"name": "エコーヴォイス",
				"description": "敵全体に275%ダメージ/敵全体のディフェンスを20%ダウン(3ターン)/自分が高揚状態の時、このスキルは必中となる",
				"tags": ["defenseDownAll", "bullseye"],
				"coolDown": "Cool Down 6 Turns"
			...
			"actionSkill2": {
				...
				"tags": ["plusUltraGaugeUpAll", "speedDownSingle", "ecstaticSingle"],
				"coolDown": "Cool Down 5 Turns"
		...
		},
		{
			...
			"autoSkill1": {
				...
				"tags": ["skillImpactUpSingle", "speedUpAll"],
			},
			"autoSkill2": {
				"name": "Auto Skill Lv.3",
		...
		},
		{
			...
			"plusUltra": {
				...
				"tags": ["criticalHitRateUpSingle", "stunSingle"],
			},
			"actionSkill1": {
				"name": "ビューティ・スポット",
		...
		},
		{
			...
			"autoSkill1": {
				...
				"tags": ["powerUpSingle", "resilienceSingle"],
			},
			"autoSkill2": {
				"name": "Auto Skill Lv.3",
		...
		},
		{
			...
			"plusUltra": {
				...
				"tags": ["burningSingle", "skillImpactUpSingle"],
			...
			"autoSkill2": {
				...
				"tags": ["skillImpactUpSingle", "statusAilmentCounter", "burningSingle"],
			},
		},
		{
			"id": "1161002",
			...
			"autoSkill2": {
				...
				"tags": ["resilienceSingle", "powerUpSingle"],
			},
		},
		{
			"id": "1161003",
			...
			"actionSkill2": {
				...
				"tags": ["criticalHitRateDownSingle", "speedDownSingle"],
				"coolDown": "Cool Down 4 Turns"
			},
			"autoSkill1": {
				"name": "Auto Skill Lv.3",
		...
		},
		{
			...
			"plusUltra": {
				...
				"tags": ["hellfireSingle", "composureSingle", "skillImpactUpSingle"],
			},
			"actionSkill1": {
				"name": "プロミネンスバーン",
			...
			"autoSkill2": {
				...
				"tags": ["composureSingle", "powerUpSingle"],
			},
		},
		{
			"id": "1161005",
		...
		},
		{
			...
			"autoSkill2": {
				...
				"tags": ["criticalHitRateUpSingle", "cooldownTimeReductionSingle"],
			},
		},
		{
			"id": "1161007",
			...
			"plusUltra": {
				...
				"tags": ["burningSingle", "actionSkillImpactUpSingle", "piercingShot"],
			},
			"actionSkill1": {
				"name": "フレイムバースト",
				...
				"tags": ["criticalHitRateDownSingle", "burningSingle", "piercingShot", "skillImpactUpSingle"],
				"coolDown": "Cool Down 4 Turns"
			},
			"actionSkill2": {
				"name": "赫灼熱拳ヘルスパイダー",
				"description": "敵全体に300%ダメージ/このスキルでCHAIN成功時、自分のプルスウルトラゲージ30%アップ/敵に燃焼のキャラがいたら、このスキルに貫通を付与/敵にかばう、挑発のキャラがいたら、このスキルのスキル威力30%アップ",
				"tags": ["plusUltraGaugeUpSingle", "piercingShot", "skillImpactUpSingle"],
				"coolDown": "Cool Down 4 Turns"
			},
			"autoSkill1": {
				"name": "Auto Skill Lv.3",
			...
			"autoSkill2": {
				...
				"tags": ["skillImpactUpSingle", "speedUpAll", "powerUpSingle"],
		...
		},
		{
			...
			"actionSkill2": {
				...
				"tags": ["speedDownSingle", "speedUpSingle", "evasionSingle"],
				"coolDown": "Cool Down 6 Turns"
			},
			"autoSkill1": {
				"name": "Auto Skill Lv.3",
			...
			"autoSkill2": {
				...
				"tags": ["evasionSingle", "speedUpSingle", "skillImpactUpSingle"],
			},
		},
		{
			"id": "1162003",
			...
			"actionSkill2": {
				...
				"tags": ["powerUpSingle", "speedUpSingle", "criticalHitRateDownSingle", "evasionSingle"],
				"coolDown": "Cool Down 4 Turns"
			},
			"autoSkill1": {
				"name": "Auto Skill Lv.3",
				"description": "おとぼけヒーロー 戦闘開始後、味方全体のスピードを25%アップ(3ターン)、自分のクリティカル率が20%ダウン(3ターン)/クリティカルが発生しなかった時、自分のパワーを5%アップ(最大20回)",
				"tags": ["speedUpAll", "criticalHitRateDownSingle", "powerUpSingle"],
			},
			"autoSkill2": {
				"name": "Auto Skill Lv.3",
		...
		},
		{
			...
			"plusUltra": {
				...
				"tags": ["skillImpactUpSingle", "criticalResistanceUpSingle", "evasionSingle", "piercingShot"],
			},
			"actionSkill1": {
				"name": "刺突蹴撃",
			...
			"actionSkill2": {
				...
				"tags": ["skillImpactUpSingle", "criticalHitRateDownSingle", "evasionSingle"],
				"coolDown": "Cool Down 3 Turns"
		...
		},
		{
			...
			"autoSkill1": {
				...
				"tags": ["evasionSingle", "criticalHitImpactUpAll"],
			},
			"autoSkill2": {
				"name": "Auto Skill Lv.3",
		...
		},
		{
			...
			"autoSkill2": {
				...
				"tags": ["criticalHitImpactUpAll", "cooldownTimeReductionSingle", "cancelStatusAilmentsSingle"],
			},
		},
		{
			"id": "1179001",
			...
			"actionSkill2": {
				...
				"tags": ["recoverySingle", "cover", "defenseUpSingle"],
				"coolDown": "Cool Down 5 Turns"
		...
		},
		{
			...
			"actionSkill1": {
				...
				"tags": ["damageDownSingle", "evasionSingle", "actionSkillImpactUpAll"],
				"coolDown": "Cool Down 5 Turns"
			},
			"actionSkill2": {
				"name": "剛翼散弾",
		...
		},
		{
			...
			"plusUltra": {
				...
				"tags": ["skillImpactUpSingle", "cooldownTimeReductionSingle"],
		...
		},
		{
			...
			"autoSkill1": {
				...
				"tags": ["statusAilmentNullSingle", "criticalHitImpactUpSingle"],
			},
			"autoSkill2": {
				"name": "Auto Skill Lv.3",
		...
		},
		{
			...
			"plusUltra": {
				...
				"tags": ["actionSkillImpactUpSingle", "piercingShot"],
			},
			"actionSkill1": {
				"name": "剛翼散弾",
				"description": "敵全体に325%ダメージ/敵全体のパワーを25%ダウン(3ターン)/自分のディフェンスが10%ダウン(4ターン)",
				"tags": ["powerDownAll", "defenseDownSingle"],
				"coolDown": "Cool Down 4 Turns"
			...
			"autoSkill1": {
				...
				"tags": ["actionSkillImpactUpSingle", "evasionSingle"],
			},
			"autoSkill2": {
				"name": "Auto Skill Lv.3",
				"description": "内なる正義 自分のアクションスキルのクールタイムを1短縮する(3ターン毎)(最大2回)/自分のディフェンスがダウンしている時、自分のパワーを35%アップ",
				"tags": ["cooldownTimeReductionSingle", "powerUpSingle"],
			},
		},
		{
			"id": "1180007",
			...
			"plusUltra": {
				...
				"tags": ["burningSingle", "cooldownTimeExtensionSingle", "piercingShot", "skillImpactUpSingle"],
			},
			"actionSkill1": {
				"name": "雨覆羽",
				...
				"tags": ["plusUltraMoveImpactUpAll", "speedUpSingle", "plusUltraGaugeUpAll", "agile", "cooldownTimeUpSingle"],
				"coolDown": "Cool Down 4 Turns"
			...
			"actionSkill2": {
				...
				"tags": ["skillImpactUpSingle", "removeBuffsAll", "recoveryBlockSingle"],
				"coolDown": "Cool Down 4 Turns"
			...
			"autoSkill1": {
				...
				"tags": ["plusUltraMoveImpactUpSingle", "evasionSingle", "skillImpactUpSingle"],
		...
		},
		{
			...
			"actionSkill1": {
				...
				"tags": ["fear", "powerDownSingle", "skillImpactUpSingle"],
				"coolDown": "Cool Down 4 Turns"
			},
			"actionSkill2": {
				"name": "壊死",
		...
		},
		{
			...
			"actionSkill2": {
				...
				"tags": ["defenseDownSingle", "criticalHitRateDownSingle", "plusUltraGaugeUpSingle"],
				"coolDown": "Cool Down 5 Turns"
			},
			"autoSkill1": {
				"name": "Auto Skill Lv.3",
		...
		},
		{
			...
			"actionSkill2": {
				...
				"tags": ["plusUltraGaugeUpSingle", "evasionSingle", "speedUpSingle"],
				"coolDown": "Cool Down 7 Turns"
			},
			"autoSkill1": {
				"name": "Auto Skill Lv.3",
		...
		},
		{
			...
			"actionSkill2": {
				...
				"tags": ["criticalHitRateUpSingle", "skillImpactDownAll"],
				"coolDown": "Cool Down 4 Turns"
			},
			"autoSkill1": {
				"name": "Auto Skill Lv.3",
		...
		},
		{
			...
			"actionSkill2": {
				...
				"tags": ["cooldownTimeReductionSingle", "evasionSingle", "speedDownSingle"],
				"coolDown": "Cool Down 6 Turns"
			},
			"autoSkill1": {
				"name": "Auto Skill Lv.3",
		...
		},
		{
			...
			"actionSkill2": {
				...
				"tags": ["plusUltraGaugeUpSingle", "cancelStatusAilmentsSingle", "plusUltraMoveImpactUpSingle"],
				"coolDown": "Cool Down 5 Turns"
			},
			"autoSkill1": {
				"name": "Auto Skill Lv.3",
		...
		},
		{
			...
			"plusUltra": {
				...
				"tags": ["skillImpactUpSingle", "burningSingle"],
			},
			"actionSkill1": {
				"name": "堕落ノ蒼",
			...
			"actionSkill2": {
				...
				"tags": ["burningAll", "burnHitRateUpSingle"],
				"coolDown": "Cool Down 4 Turns"
			},
			"autoSkill1": {
				"name": "Auto Skill Lv.3",
		...
		},
		{
			...
			"actionSkill1": {
				...
				"tags": ["burningAll", "criticalHitRateUpSingle"],
				"coolDown": "Cool Down 5 Turns"
			},
			"actionSkill2": {
				"name": "粛清ノ蒼",
			...
			"autoSkill1": {
				...
				"tags": ["burnHitRateUpAll", "burnResistDownAll", "actionSkillImpactUpSingle"],
			},
			"autoSkill2": {
				"name": "Auto Skill Lv.3",
				"description": "悪いのはクズ共だ 戦闘開始後、味方全体の\"敵連合\"のプルスウルトラゲージを25%アップ/自分の燃焼のダメージを30%軽減",
				"tags": ["plusUltraGaugeUpSingle", "burningDamageDownSingle"],
			},
		},
		{
			"id": "1185005",
			...
			"autoSkill1": {
				...
				"tags": ["skillImpactUpSingle", "plusUltraGaugeUpSingle", "burningAll"],
			},
			"autoSkill2": {
				"name": "Auto Skill Lv.3",
				"description": "大胆な采配 自分が燃焼状態の時、味方全体が氷結、凍傷状態になる確率を下げ、味方全体の燃焼のダメージを20%軽減、敵全体のスピードを30%ダウン",
				"tags": ["freezeResistDownAll", "frostbiteResistUpAll", "burningDamageDownAll", "speedDownAll"],
			},
		},
		{
			"id": "1186001",
		...
		},
		{
			...
			"actionSkill1": {
				...
				"tags": ["bleedingSingle", "plusUltraGaugeUpSingle"],
				"coolDown": "Cool Down 4 Turns"
			},
			"actionSkill2": {
				"name": "自分らしく",
				"description": "自分のプルスウルトラゲージを60%アップ/自分のクリティカル率を30%アップ(4ターン)/自分のプルスウルトラ技の威力を20%アップ(4ターン)",
				"tags": ["plusUltraGaugeUpSingle", "criticalHitRateUpSingle", "plusUltraMoveImpactUpSingle"],
				"coolDown": "Cool Down 6 Turns"
			},
			"autoSkill1": {
				"name": "Auto Skill Lv.3",
			...
			"autoSkill2": {
				...
				"tags": ["ecstaticSingle", "skillImpactUpSingle"],
			},
		},
		{
			"id": "1186003",
			...
			"autoSkill2": {
				...
				"tags": ["skillImpactUpSingle", "powerUpSingle"],
			},
		},
		{
			"id": "1186005",
			...
			"autoSkill2": {
				...
				"tags": ["bleedHitRateUpSingle", "criticalHitRateUpSingle", "plusUltraGaugeUpSingle", "criticalHitRateDownAll"],
			},
		},
		{
			"id": "1187001",
			...
			"plusUltra": {
				...
				"tags": ["bleedingSingle", "powerUpSingle"],
			...
			"autoSkill1": {
				...
				"tags": ["barrierSingle", "criticalHitRateUpSingle"],
		...
		},
		{
			...
			"plusUltra": {
				...
				"tags": ["skillImpactUpSingle", "barrierSingle"],
			},
			"actionSkill1": {
				"name": "メジャーウィップ",
		...
		},
		{
			...
			"actionSkill1": {
				...
				"tags": ["defenseDownSingle", "ecstaticSingle"],
				"coolDown": "Cool Down 5 Turns"
			},
			"actionSkill2": {
				"name": "\"個性\"「二倍」の恐怖",
			...
			"autoSkill1": {
				...
				"tags": ["maxHpUpSingle", "criticalHitRateUpSingle"],
			},
			"autoSkill2": {
				"name": "Auto Skill Lv.3",
				"description": "驚異的な“個性” 自分のHPが30%未満になった時、戦闘中に1度だけ自分のパワーを30%アップ、自分のHPを100%回復",
				"tags": ["powerUpSingle", "recoverySingle"],
			},
		},
		{
			"id": "1190003",
			...
			"actionSkill2": {
				...
				"tags": ["plusUltraGaugeUpAll", "recoverySingle"],
				"coolDown": "Cool Down 5 Turns"
			...
			"autoSkill2": {
				...
				"tags": ["powerUpAll", "skillImpactUpSingle"],
			},
		},
		{
			"id": "1191001",
			...
			"plusUltra": {
				...
				"tags": ["boundSingle", "cooldownTimeReductionSingle"],
			},
			"actionSkill1": {
				"name": "ステッキマジック",
				"description": "敵単体に350%ダメージ/敵単体に低 確率 (20%)で拘束(1ターン)を付与/自分のクリティカル率を20%アップ(3ターン)",
				"tags": ["boundSingle", "criticalHitRateUpSingle"],
				"coolDown": "Cool Down 4 Turns"
		...
		},
		{
			...
			"plusUltra": {
				...
				"tags": ["removeBuffsAll", "defenseDownSingle"],
			},
			"actionSkill1": {
				"name": "黒爪",
			...
			"autoSkill1": {
				...
				"tags": ["powerDownAll", "cooldownTimeReductionAll"],
		...
		},
		{
			...
			"plusUltra": {
				...
				"tags": ["skillImpactUpSingle", "bullseye", "evasionSingle"],
		...
		},
		{
			...
			"autoSkill2": {
				...
				"tags": ["skillImpactUpSingle", "ecstaticSingle"],
			},
		},
		{
			"id": "1210002",
			...
			"plusUltra": {
				...
				"tags": ["skillImpactUpSingle", "bleedingSingle", "evasionAll"],
			},
			"actionSkill1": {
				"name": "山嵐",
		...
		},
		{
			...
			"actionSkill2": {
				...
				"tags": ["statusAilmentCounter", "meatLumpSingle", "plusUltraGaugeUpSingle", "criticalHitRateUpAll"],
				"coolDown": "Cool Down 5 Turns"
		...
		},
		{
			...
			"plusUltra": {
				...
				"tags": ["charmedSingle", "skillImpactDownSingle"],
			},
			"actionSkill1": {
				"name": "マジ驚嘆",
				"description": "敵全体に中 確率 (40%)で魅了(3ターン)を付与/味方全体のプルスウルトラゲージを30%アップ",
				"tags": ["charmedAll", "plusUltraGaugeUpAll"],
				"coolDown": "Cool Down 5 Turns"
			...
			"actionSkill2": {
				...
				"tags": ["defenseDownSingle", "speedDownSingle", "confusionSingle", "charmedSingle"],
				"coolDown": "Cool Down 6 Turns"
		...
		},
		{
			...
			"autoSkill1": {
				...
				"tags": ["speedUpAll", "lastStandSingle"],
			},
			"autoSkill2": {
				"name": "Auto Skill Lv.3",
		...
		},
		{
			...
			"actionSkill2": {
				...
				"tags": ["frostbiteAll", "speedDownAll", "plusUltraGaugeUpSingle"],
				"coolDown": "Cool Down 4 Turns"
			},
			"autoSkill1": {
				"name": "Auto Skill Lv.3",
			...
			"autoSkill2": {
				...
				"tags": ["burnResistUpAll", "burningDamageDownAll", "damageDownSingle"],
			},
		...
		},
		{
			...
			"actionSkill2": {
				...
				"coolDown": "Cool Down 5 Turns",
				"tags": ["cancelStatusAilmentsSingle", "powerUpSingle", "defenseUpSingle"],
			},
			"autoSkill1": {
				"name": "Auto Skill Lv.3",
		...
		},
		{
			...
			"plusUltra": {
				...
				"tags": ["maxHpUpAll", "bullseye", "piercingShot"],
			},
			"actionSkill1": {
				"name": "重圧陥",
			...
			"autoSkill1": {
				...
				"tags": ["damageDownSingle", "powerUpSingle", "maxHpUpSingle", "stress"],
			},
			"autoSkill2": {
				"name": "Auto Skill Lv.3",
		...
		},
		{
			...
			"plusUltra": {
				...
				"tags": ["piercingShot", "removeBuffsSingle", "bullseye"],
			},
			"actionSkill1": {
				"name": "一発必中",
			...
			"actionSkill2": {
				...
				"coolDown": "Cool Down 4 Turns",
				"tags": ["piercingShot", "bindImmunity", "cooldownTimeReductionSingle", "hideSingle"],
			},
			"autoSkill1": {
				"name": "Auto Skill Lv.3",
				"description": "スナイパーライフル人間 自分に必中(2ターン)を付与/3ターン毎に、自分に必中(1ターン)を付与/自分が必中の時、自分のスキル威力を35%アップ、スピードを30%アップ",
				"tags": ["bullseye", "skillImpactUpSingle", "speedUpSingle"],
			},
			"autoSkill2": {
				"name": "Auto Skill Lv.3",
				"description": "一撃必殺 3ターン毎に、自分に隠れる(2ターン)を付与/自分が隠れるの時、自分のクリティカル率を35%アップ、クリティカル時の威力を25%アップ",
				"tags": ["hideSingle", "criticalHitRateUpSingle", "criticalHitImpactUpSingle"],
			},
		},
		{
			"id": "1239001",
			...
			"plusUltra": {
				...
				"tags": ["barrierSingle", "cooldownTimeReductionSingle"],
			},
			"actionSkill1": {
				"name": "リフレクション",
				"description": "自分に通常攻撃を無効化した上でカウンターする状態(3ターン)を付与、挑発(3ターン)を付与、ダメージを35%カット(3ターン)",
				"coolDown": "Cool Down 5 Turns",
				"tags": ["counter", "aggro", "damageDownSingle"]
			},
			"actionSkill2": {
				"name": "リフレクトウェーブ",
		...
		},
		{
			...
			"actionSkill2": {
				...
				"tags": ["defenseDownSingle", "speedDownSingle", "skillImpactUpSingle"],
				"coolDown": "Cool Down 4 Turns"
			},
			"autoSkill1": {
				"name": "Auto Skill Lv.3",
				...
				"tags": ["maxHpUpSingle", "speedUpSingle", "skillImpactUpSingle", "powerUpSingle", "cooldownTimeReductionSingle"],
			},
			"autoSkill2": {
				"name": "Auto Skill Lv.3",
				"description": "平和への貢献 自分のHPが50%未満の時、自分に回避(3回)を付与(最大1回)/自分が戦闘不能になった時、敵全体のスピード30%ダウン(3ターン)、ディフェンス20%ダウン(3ターン)",
				"tags": ["evasionSingle", "speedDownAll", "defenseDownAll"],
			},
		}
	]
};
